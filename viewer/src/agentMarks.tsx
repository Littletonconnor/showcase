...
// trademarks belong to their owners and are used here only to label which agent
// authored a session. Rendered inline with `fill="currentColor"` so they take
...
// lucide: square-terminal — the fallback for an unrecognized agent
...
// Map an agent name to its mark. Names are matched loosely (lowercased, and by
// leading token) so "claude", "claude-code", "Claude Code" all resolve to one.
